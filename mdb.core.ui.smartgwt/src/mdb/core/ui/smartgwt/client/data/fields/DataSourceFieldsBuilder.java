...
import mdb.core.ui.smartgwt.client.data.fields.editors.ButtonItemSelectEditor;
import mdb.core.ui.smartgwt.client.data.fields.editors.TextItemEditor;
import mdb.core.ui.smartgwt.client.data.validators.DataValidators;
		...
		DataSourceFields  fieldsList = null;		
	    	...
	    	if (requstData!= null && requstData.getName() != null && requstData.getName().contains(IDataSourceFieldsBuilder.FLD_ENTITY_DESC_KEY) )  
	    	{
	    		...
	    		if (data != null && !data.equals("[null]")) {
					JavaScriptObject obj =  JSON.decode(requstData.getData());		    	
