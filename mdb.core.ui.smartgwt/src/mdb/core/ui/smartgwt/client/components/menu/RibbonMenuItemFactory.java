 ...
 *
 */
public class RibbonMenuItemFactory implements IMenuItemFactory, IMenuFactory {
	...
	/* (non-Javadoc)
	 * @see mdb.core.ui.smartgwt.components.menu.IMenuItemFactory#createMenuContainer()
	 */
	@Override
